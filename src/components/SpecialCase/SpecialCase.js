...
const SpecialCase = () => {
  ...
  return (
    <div className="fixed top-80 right-2 z-50 hidden md:flex flex-col gap-2">
      <Link to="/profile">
        <div className="bg-white lg:w-16 lg:h-[60px] md:w-20 md:h-[50px]  rounded-2xl flex flex-col gap-1  justify-center items-center shadow-testShadow overflow-x-hidden group cursor-pointer hover:bg-[#6A9AB0] hover:text-white">
          <div className="flex justify-center items-center">
            <FaUserCircle  className="text-primeColor text-2xl transition-transform duration-200 group-hover:text-white" />
