...
const HeaderBottom = () => {
  ...
  return (
    <div className="parent-div w-full p-2 h-full relative border-t-2">
      <div className="mx-auto">
        <Flex className="flex flex-col lg:flex-row items-start lg:items-center justify-between w-full px-4 lg:pb-0 h-full">
          ...
          {/* Search Bar */}
          <div className="relative w-full lg:w-1/3 md:h-[50px] xs:h-[40px] text-base text-primeColor border border-gray-300 shadow-md bg-white flex items-center gap-2 justify-between px-6 rounded-xl mt-2 lg:mt-2">
            <input
            ...
            {!searchValue && (
              <span className="absolute inset-0 flex items-center px-6 pointer-events-none font-body3 font-medium text-[#464646]">
                <TypeAnimation
                  sequence={[
                    'Search for Food packing containers ...',
                    1000,
                    'Search for Thermalpapers ...',
                    1000,
                    'Search for Aluminum foils ...',
                    1000,
                    'Search for Medical devices ...',
                    1000,
                    'Search for Nitrile gloves ...',
                    1000,
                    'Search for Eye cooling gels ...',
                    1000,
                    'Search for Absorbent cottons ...',
                    1000,
                  ]}
                  wrapper="span"
                  speed={50}
          ...
          <div className="flex gap-4 lg:mt-0 xs:mt-3 items-center pr-6 cursor-pointer relative">
            <button
              ...
              className="border hover:border-gray-400 shadow-md bg-white transition-all py-3 px-3 rounded-2xl hover:rounded-md flex items-center gap-3 group hover:scale-105 duration-300"
            >
            ...
            <Link to="/cart">
              <div className="relative">
                <button className=" border hover:border-gray-400 shadow-md bg-white transition-all py-[13.5px] px-[13.5px] rounded-2xl hover:rounded-md flex items-center gap-3 group hover:scale-105 duration-300">
                  <FaShoppingCart className="text-primeColor" />
                  <span className="absolute font-body1 top-0 -right-2 text-xs w-4 h-4 flex items-center text-center justify-center rounded-full font-semibold bg-[#6A9AB0] text-white">
