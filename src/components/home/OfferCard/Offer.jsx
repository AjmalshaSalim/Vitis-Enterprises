            ...
            <div className='max-w-full flex lg:flex-row xs:flex-col justify-center items-center h-full gap-10 mx-auto md:p-10 lg:p-10 mb-4 relative overflow-hidden'>
                ...
                <div className='relative lg:w-[1000px] xs:w-full h-auto rounded-lg shadow-sm shadow-primeColor mt-5 flex lg:flex-row xs:flex-col' data-aos="fade-up">
                    ...
                    <div className='lg:w-1/2 xs:w-full bg-white flex flex-col justify-center items-center p-4'>
                        <h2 className='text-primeColor lg:text-4xl xl:text-4xl md:text-2xl sm:text-base xs:text-base font-body3 font-medium text-center'>For Product Related Services</h2>
                        <div className='flex items-center gap-2 mt-4'>
                            <a href="mailto:vitisenterprises@gmail.com" className='bg-primeColor font-body3 text-white py-2 px-4 rounded-full flex items-center justify-center hover:bg-black hover:text-white transition-colors'>
                                Email Us <AiOutlineArrowRight className='ml-2' />
                            </a>
                            <a href="https://wa.me/917736921309" className='bg-primeColor font-body3 text-white py-2 px-4 rounded-full flex items-center justify-center hover:bg-black hover:text-white transition-colors'>
