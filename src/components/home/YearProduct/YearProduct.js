...
const YearProduct = () => {
  return (
    <Link to="/shop">
      <div className="w-full lg:container  mb-20 bg-[#ffffff]  relative font-titleFont flex flex-col md:flex-row items-center justify-center" data-aos="fade-up" data-aos-duration="1000" >
